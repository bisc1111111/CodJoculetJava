...
public class Board extends JPanel implements ActionListener, KeyListener {
    ...
    public static final int num_armor = 2;
    ...
    private final ArrayList<Weapons> weapon;
    ...
    public Board() {
        ...
        Character player = new Character(100, 100, 2, 0, 0);
        weapon = populateWeapons();
    ...
    private ArrayList<Weapons> populateWeapons() {
        ...
        for (int i = 0; i < num_weapons; i++) {
            int weaponX = rand.nextInt(COLUMNS);
            int weaponY = rand.nextInt(ROWS);
            weapon.add(new Weapons(weaponX, weaponY));
        }
